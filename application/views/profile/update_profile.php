...
<strong>Referral ID: </strong><?php echo $userDetails->referral; ?>
    ...
    <form action="" method="POST">
        ...
        <select class="form-control input-sm" name="InputGender" >
            ...
            <input name="InputReferral" type="hidden" class="form-control input-sm" value="<?php echo $userDetails->referral; ?>">
        <br/>
...
<div class="col-md-6">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <strong>Spree ID:</strong>
            <strong> <?php echo $userDetails->userid; ?></strong><br/>
            <strong>NAME : <?php echo $userDetails->name; ?></strong><br/>
            <strong>COLLEGE : <?php echo $userDetails->college == '0' ? 'not updated' : $userDetails->college; ?></strong>
            <strong>CITY : <?php echo $userDetails->city == '0' ? 'not updated' : $userDetails->city ; ?></strong><br/>
            <strong>STATE : <?php echo $userDetails->state; ?></strong><br/>
