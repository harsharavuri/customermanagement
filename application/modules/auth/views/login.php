<!DOCTYPE html><?php $fest='Customer Management' ?>
<html lang="en">
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="description" content="Authentication of credentials">
<meta name="author" content="Devendra Dora">
<title> <?php echo $fest ?> Management System </title>
...
<body>
    <div class="container">
        ...
        <div class="row">
            <hr>
            <p class="pull-right help-block"><span class="glyphicon glyphicon-copyright-mark"> </span> <?php echo date('Y').' , '.$fest.'  NITW' ?></p>
            <p class="pull-left help-block"><span class="glyphicon glyphicon-envelope"> </span></span> +91-123456789</p>
        </div>
    </div>
