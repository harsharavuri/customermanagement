...
$config['site_title']                 = "sprigspree.in";       // Site Title, example.com
$config['admin_email']                = "dev@gmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'event_manager';           // Default group, use name
