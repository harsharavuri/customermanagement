$('#workshop-selected').on('change',function(){
    if($('#workshop-selected').val()==100){
        alert('yo');
    }
});
...
function getRow(slno) {
    var row =
        ...
        '<td>'+
        '<input name="userid" class="participant-id form-control input-sm" type="text" data-registration="no" placeholder="Enter your team-mates Spree-ID">' +
