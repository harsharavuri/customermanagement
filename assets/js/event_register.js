function getRow(slno) {
    ...
    '<td><input title="Enter Teammate springspree-ID" required class="participant-id tips form-control input-sm" type="text" placeholder="Enter teammate springspree-ID"></td>' +
